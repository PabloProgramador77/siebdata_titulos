<x-adminlte-modal id="modalEditar" title="Editar Titulación" theme="info" static-backdrop scrollable>
    ...
    <div class="container-fluid border-bottom">
        ...
        <form novalidate>
            <div class="form-group">
                <x-adminlte-input name="idEditar" id="idEditar" placeholder="* ID de titulación">
