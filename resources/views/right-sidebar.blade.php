    ...
    <div class="row">
        <div class="col-12">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link" id="v-pills-home-tab" data-toggle="pill" href="#" role="tab" aria-controls="v-pills-home" aria-selected="false">
                    <img src="{{ asset('icons/etiqueta.png') }}" alt="" width="25px" height="auto" class="p-1 rounded"> Cargos
                </a>
                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                    <img src="{{ asset('icons/escuela.png') }}" alt="" width="25px" height="auto" class="p-1 rounded"> Autoridades de RVOE
                </a>
                <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                    <img src="{{ asset('icons/mapa.png') }}" alt="" width="25px" height="auto" class="p-1 rounded"> Entidades Federativas
                </a>
                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#" role="tab" aria-controls="v-pills-settings" aria-selected="false">
