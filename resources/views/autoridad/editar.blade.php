<x-adminlte-modal id="modalEditar" title="Editar Autoridad" theme="info" static-backdrop scrollable>
    ...
    <div class="container-fluid border-bottom">
        ...
        <form novalidate>
            <div class="form-group">
                <x-adminlte-input name="idEditar" id="idEditar" placeholder="* ID de autoridad">
                ...
                <x-adminlte-input name="nombreEditar" id="nombreEditar" placeholder="* Nombre de autoridad">
                    <x-slot name="prependSlot">
                        <div class="input-group-text tex-info">
