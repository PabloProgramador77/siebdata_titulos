    ...
    <div class="container-fluid col-md-12 bg-white rounded p-3 shadow">
        ...
        <form novalidate class="container-fluid row">
            ...
            <div class="form-group col-md-4">
                <x-adminlte-input name="nombre" label="*Nombre de IPES" placeholder="Nombre de IPES" label-class="text-info" value="{{ $user->name }}">
            ...
            <div class="form-group col-md-4">
                <x-adminlte-input name="clave" label="*Clave de IPES" placeholder="Clave de IPES" label-class="text-info" value="{{ $user->clave }}">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
            ...
            <div class="form-group col-md-4">
                <x-adminlte-input type="email" name="email" label="*Email de IPES" placeholder="Email de IPES" label-class="text-info" value="{{ $user->email }}">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
            ...
            <div class="form-group col-md-4">
                <x-adminlte-input type="password" name="password" label="Password de IPES" placeholder="Password de IPES" label-class="text-info">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
            ...
            <div class="form-group col-md-4">
                <x-adminlte-input type="password" name="confirmPassword" label="Confirmación de password" placeholder="Confirmación de password" label-class="text-info">
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
